...
public class HibernateUtil {
    ...
    public static Object findFirst(Class oClass, String field, String value) {
        List r = find(oClass, field, value);
        if (r != null && r.size() != 0)
            return r.get(0);
        else
            return null;
    ...
    public static List find(Class oClass, String field, String value) {
        Criterion criteria[] = { Restrictions.like(field, value) };
        return findComplex(oClass, criteria);
    }

    public static List findComplex(Class oClass, Criterion[] criteria) {
